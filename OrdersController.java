 ...
 * @author Admin
 */
@WebServlet(name = "Orders", urlPatterns = {"/OrdersURL"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (service.equals("insertOrders")) {
                ...
                Orders pro = new Orders(EmployeeId, ShipViA, CustomerID, OrderDate, RequiredDate, ShippedDate, ShipName, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry, FreighT);
                // Thêm đơn hàng vào database
                int n = dao.addOrder(pro);
                response.sendRedirect("OrdersURL?service=listAllOrders");
            ...
            if (service.equals("listAllOrders")) {
                ...
                out.print("<form action=\"OrdersURL\" method=\"get\">\n"
                        + "  <p>\n"
                ...
                for (Orders orders : vector) {
                    out.println("<tr>\n"
                            ...
                            + "  <td></td>"
                           + "<td><a href=\"OrdersURL?service=deleteOrders&oid="+orders.getOrderID()+"\">Delete</a></td>\n"
                            + "</tr>");
